...
<%--                </form>--%>
                ...
                <ul class="category-ul">
                    ...
                    <a href="${pageContext.request.contextPath}/CreateOfferBundle" class="btn btn-primary bundle-button" style="background-color: deeppink; border-color: deeppink">Create offer bundle</a>
            </div>
