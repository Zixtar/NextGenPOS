...
<t:pageTemplate pageTitle="Create Sale">
  ...
  <div class="container justify-content-center">
        ...
        <c:forEach var="saleProduct" items="${saleProducts}" varStatus="status">
          <div class="Sale-Item d-flex justify-content-between align-items-center">
            ...
            <div style="width: fit-content;">
              <div class="text-center" name="qty${status.index}">Qty:${saleProduct.quantity}</div>
            ...
            <div class="text-center"> Price: <b>${saleProduct.price}</b> RON </div>
    ...
    <div class="d-flex justify-content-end">
      <div class="justify-self-end"> Total:<span name="Total">${totalPrice}</span> RON</div>
    </div>
