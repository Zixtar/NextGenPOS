      ...
      <c:if test="${not empty saleProducts}">
        <c:forEach var="saleProduct" items="${saleProducts}" varStatus="status">
          <div class="Sale-Item d-flex justify-content-between align-items-center">
            <img src="${pageContext.request.contextPath}/ProductPhotosIds?id=${PhotoId}" width="50px" height="50px"/>
            <div class="text-center">${ProductName}</div>
            <div>
              <div class="text-center">Qty:${Quantity}</div>
