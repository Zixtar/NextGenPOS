...
<nav class="header_bar navbar navbar-dark bg-dark" >
    <div class="container-fluid">
        ...
        <div class="navbar-collapse me-1 pt-0 " >
            <ul class="navbar nav">
                <li class="nav-item">
                    <button class="hamburger_button" id="hamburger_button" type="button"  data-bs-toggle="collapse" aria-expanded="false" data-bs-target="#hamby" aria-controls="#hamby">
...
<div class="hamburger-menu collapse mt-0" id="hamby">
    <h2>All products</h2>
    ...
    <button type="button" id="close_btn"  data-bs-toggle="collapse"  data-bs-target="#hamby" >
...
>>>>>>> Stashed changes:src/main/webapp/header.jsp
